...
export default class Relay {
    ...
    addNewPublicKey(identityAddress, newPublicKey) {
        return new Promise(async (resolve, reject) => {
            ...
            const identity = (new IdentityRepository()).getIdentityFromLocalStorage();
            ...
            //2. send to relay
            console.log(identityAddress,newPublicKey)
            const res = await axios.post(Relay.RELAY_HOST + '/key', {
